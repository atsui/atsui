`<atsui-paginator>` provides navigation for paged information, typically used with a table.
...
The labels for the paginator can be customized by providing your own instance of `AtsuiPaginatorI18n`.
...
### Accessibility
The `aria-label`s for next page, previous page, first page and last page buttons can be set in `AtsuiPaginatorI18n`.