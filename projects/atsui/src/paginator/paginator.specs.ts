...
import {AtsuiPaginatorModule, AtsuiPaginator, AtsuiPaginatorI18n} from './public_api';

describe('AtsuiPaginator', () => {
  let fixture: ComponentFixture<AtsuiPaginatorApp>;
  let component: AtsuiPaginatorApp;
  let paginator: AtsuiPaginator;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        AtsuiPaginatorApp,
        AtsuiPaginatorWithoutPageSizeApp,
        AtsuiPaginatorWithoutOptionsApp,
        AtsuiPaginatorWithoutInputsApp,
        AtsuiPaginatorWithStringValues
      ],
      providers: [AtsuiPaginatorI18n]
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(AtsuiPaginatorApp);
  ...
  describe('with the default internationalization provider', () => {
    it('should show the right range text', () => {
      const rangeElement = fixture.nativeElement.querySelector('.atsui-paginator-range-label');
    ...
    it('should re-render when the i18n labels change',
      inject([AtsuiPaginatorI18n], (intl: AtsuiPaginatorI18n) => {
        const label = fixture.nativeElement.querySelector('.atsui-paginator-page-size-label');
  ...
  it('should default the page size options to the page size if no options provided', () => {
    const withoutOptionsAppFixture = TestBed.createComponent(AtsuiPaginatorWithoutOptionsApp);
  ...
  it('should default the page size to the first page size option if not provided', () => {
    const withoutPageSizeAppFixture = TestBed.createComponent(AtsuiPaginatorWithoutPageSizeApp);
  ...
  it('should handle the number inputs being passed in as strings', () => {
    const withStringFixture = TestBed.createComponent(AtsuiPaginatorWithStringValues);
  ...
  it('should be able to hide the page size select', () => {
    ...
    expect(element.querySelector('.atsui-paginator-page-size'))
...
function getPreviousButton(fixture: ComponentFixture<any>) {
  return fixture.nativeElement.querySelector('.atsui-paginator-navigation-previous');
}

function getNextButton(fixture: ComponentFixture<any>) {
  return fixture.nativeElement.querySelector('.atsui-paginator-navigation-next');
}

function getFirstButton(fixture: ComponentFixture<any>) {
    return fixture.nativeElement.querySelector('.atsui-paginator-navigation-first');
}

function getLastButton(fixture: ComponentFixture<any>) {
    return fixture.nativeElement.querySelector('.atsui-paginator-navigation-last');
}

@Component({
  template: `
    <atsui-paginator [pageIndex]="pageIndex"
                   [pageSize]="pageSize"
...
class AtsuiPaginatorApp {
  ...
  @ViewChild(AtsuiPaginator, {}) paginator: AtsuiPaginator;
//   @ViewChild(AtsuiPaginator, {static: false}) paginator: AtsuiPaginator;
...
@Component({
  template: `
    <atsui-paginator></atsui-paginator>
  `,
})
class AtsuiPaginatorWithoutInputsApp {
  @ViewChild(AtsuiPaginator, {}) paginator: AtsuiPaginator;
//   @ViewChild(AtsuiPaginator, {static: false}) paginator: AtsuiPaginator;
}
...
@Component({
  template: `
    <atsui-paginator [pageSizeOptions]="[10, 20, 30]"></atsui-paginator>
  `,
})
class AtsuiPaginatorWithoutPageSizeApp {
  @ViewChild(AtsuiPaginator, {}) paginator: AtsuiPaginator;
//   @ViewChild(AtsuiPaginator, {static: false}) paginator: AtsuiPaginator;
}
...
@Component({
  template: `
    <atsui-paginator [pageSize]="10"></atsui-paginator>
  `,
})
class AtsuiPaginatorWithoutOptionsApp {
  @ViewChild(AtsuiPaginator, {}) paginator: AtsuiPaginator;
//   @ViewChild(AtsuiPaginator, {static: false}) paginator: AtsuiPaginator;
}
...
class AtsuiPaginatorWithStringValues {
  @ViewChild(AtsuiPaginator, {}) paginator: AtsuiPaginator;
//   @ViewChild(AtsuiPaginator, {static: false}) paginator: AtsuiPaginator;
}